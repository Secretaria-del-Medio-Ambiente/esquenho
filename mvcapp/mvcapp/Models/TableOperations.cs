...
namespace mvcapp.Models
{
    ...
    public class TableOperations : ITableOperations
    {
        ...
        public TableOperations()
        {
            ...
            storageAccount = CloudStorageAccount.Parse(ConfigurationManager.AppSettings["nteacgcesma"]);
        ...
        public List<ProfileEntity> GetEntities(string filter)
        {
            ...
            foreach (var item in table.ExecuteQuery(query))
            {
                Profiles.Add(new ProfileEntity()
                {
                    ...
                    NombreDelOrganismoPúblico_EmpresaPrivada = item.NombreDelOrganismoPúblico_EmpresaPrivada,
                    Estado = item.Estado,
                    Municipio = item.Municipio,
                    NúmeroContacto = item.NúmeroContacto,
                    Email = item.Email
